...
//! Generated `maddy.conf` (Madmail-compatible; madmail-v2 uses `tls file` + `madmail certificate`).
...
# TLS: madmail-v2 uses PEM files (`madmail certificate get` for Let's Encrypt autocert)
